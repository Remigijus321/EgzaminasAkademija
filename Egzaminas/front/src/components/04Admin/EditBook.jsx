...
export class EditBook extends Component {
    ...
    submitHandle(e) {
        e.preventDefault();
          ...
          http
            .put(`${apiEndpoint}/api/books/delete`, data)
            .then((response) => {
    ...
    render() {
        return (
            <div className = "container pt-4">
                ...
                <h6 className="formHeader mb-4">Input the fields below to edit an existing book</h6>
                <div className="mb-3">
                    ...
                    <button type="submit" className="btn btn-primary mt-3">Edit this book</button>
                    </form>
                </div>
        )
    }
