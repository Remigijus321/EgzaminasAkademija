...
export class DeleteBook extends Component {
    ...
    submitHandle(e) {
        e.preventDefault();
          ...
          http
            .delete(`${apiEndpoint}/api/books/delete`, data)
            .then((response) => {
    ...
    render() {
        return (
            <div className = "container pt-4">
                ...
                <h6 className="formHeader mb-4">Input the fields below to delete an existing book</h6>
                <div className="mb-3">
                    ...
                    <button type="submit" className="btn btn-primary mt-3">Delete this book</button>
                    </form>
                </div>
        )
    }
